...
sealed interface Token {
    ...
    object EOF: Token { override val lexeme: String? = null }
    ...
    enum class Operator(override val lexeme: String, val combineDirection: CombineDirection = CombineDirection.NONE) : Token {
        ...
        companion object {
            val trie = Trie(*values().map { it.lexeme }.toTypedArray())
            val table = values().associateBy { it.lexeme }
        }
    }
